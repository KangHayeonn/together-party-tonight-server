...
public class SwaggerConfig {
    ...
    private static final String[] PUBLIC = {"/members/reviews/**", "/search/**","/members/emailCheck", "/members/login", "/members/reissue", "/members/oauth/**", "/members/signup/**", "/members/password/**"};
